      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Free Tier */}
            <div className="p-8 rounded-lg border border-border bg-white shadow-sm">
            ...
            <div className="p-8 rounded-lg border-2 border-[var(--gold)] bg-white shadow-md relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[var(--gold)] text-[#0f172a] text-xs font-bold px-3 py-1 rounded-full">
                MOST POPULAR
              </div>
